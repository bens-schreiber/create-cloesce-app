...
export class Weather {
    ...
    // Optionally, decorate with @ForeignKey<WeatherReport>(w => w.id)
    ...
    @Get({ includeTree: { photo: {} }  }) // The only thing we need for this endpoint is "photo"
...
export class WeatherReport {
    ...
    // If several 1:M relationships exist, use the modelBuilder in `cloesce.config.ts`
